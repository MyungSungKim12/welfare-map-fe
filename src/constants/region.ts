...
export const SIGUNGU_MAP: Record<string, { code: string; name: string }[]> = {
  // 서울
  '11': [
  ...
  '41': [
    ...
    { code: '41130', name: '성남시 수정구' }, { code: '41131', name: '성남시 중원구' },
    { code: '41133', name: '성남시 분당구' }, { code: '41150', name: '의정부시' },
    ...
    { code: '41670', name: '여주시' }, { code: '41800', name: '가평군' },
    { code: '41820', name: '양평군' }, { code: '41840', name: '연천군' },
  ],
  // 강원
  '42': [
  ...
  // 충북
  '43': [
    { code: '43110', name: '청주시 상당구' }, { code: '43111', name: '청주시 서원구' },
    { code: '43112', name: '청주시 흥덕구' }, { code: '43113', name: '청주시 청원구' },
  ...
  // 충남
  '44': [
    { code: '44130', name: '천안시 동남구' }, { code: '44131', name: '천안시 서북구' },
  ...
  '47': [
    ...
    { code: '47290', name: '경산시' }, { code: '47720', name: '군위군' },
    { code: '47730', name: '의성군' }, { code: '47750', name: '청송군' },
    { code: '47760', name: '영양군' }, { code: '47770', name: '영덕군' },
    { code: '47820', name: '청도군' }, { code: '47830', name: '고령군' },
    { code: '47840', name: '성주군' }, { code: '47850', name: '칠곡군' },
    { code: '47900', name: '예천군' }, { code: '47920', name: '봉화군' },
    { code: '47930', name: '울진군' }, { code: '47940', name: '울릉군' },
  ],
  // 경남
  '48': [
